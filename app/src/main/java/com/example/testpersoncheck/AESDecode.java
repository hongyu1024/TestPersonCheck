...
public class AESDecode {
    ...
    public static void main(String[] args) throws Exception {
        // 发送POST请求示例
        String ak_id = "LTAIUID5sUs2WsbQ"; //用户ak
        String ak_secret = "yg0NuekLuMGVbY6EOqvD2L4kbtNsHL"; // 用户ak_secret
        ...
        // 发送GET请求
        String ak_id1 = "LTAIUID5sUs2WsbQ"; //用户ak
        String ak_secret1 = "yg0NuekLuMGVbY6EOqvD2L4kbtNsHL"; // 用户ak_secret
